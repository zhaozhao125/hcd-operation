    ...
    <el-card class="table-box">
      ...
      <div class="table-container">
        <el-table :data="tableData" height="100%">
          <el-table-column prop="recordSn" label="流水号" show-overflow-tooltip min-width="160px"></el-table-column>
          <el-table-column prop="actionCodeText" label="科目" min-width="120px"></el-table-column>
          <el-table-column prop="amount" label="金额" min-width="100px">
          </el-table-column>
...
export default {
  ...
  methods: {
    initSubject() {
      this.$service.getEnterpriseFlowSubjects({ companyMoneyType: 'balance' }).then(res => {
        console.log(res)
        if (res.data.code == '0') {
    ...
    loadTableData() {
      ...
      console.log(params)
      this.$service.getEnterpriseFlowList(params).then(res => {
