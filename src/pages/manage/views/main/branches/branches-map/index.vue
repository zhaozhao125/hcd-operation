<template>
  <div id="charging-pile-network-map">
    <div>
      <v-search :searchSettings="searchSettings" @search="handleSearch" labelWidth="100px" @operationChange = "operationChange">
                      ...
                      self.window.content = `<div class="car-panel">
                          <div class="panel-header">
                              ...
                              <div class="panel-content">
                                  <ul>
                                      <li ><span class="panel-key">运营商：</span><span class="panel-value"> ${row.operatorName} </span></li>
