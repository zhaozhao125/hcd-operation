   ...
   >
    <v-form ref="form"  :formSettings="formSettings" :showButton="false" class="edit_add_form" labelWidth = "100px" :formData="AccountInfor">
       <template slot="stationId" slot-scope="scope">
             <website-select ref="website" v-model="scope.model.stationId"  :stationName="AccountInfor.stationName" placeholder="请输入站点名称" isRequest  :open='false'       :isStationRemote = true   @changeStationName="changeStationName" >
             </website-select>
        </template>
