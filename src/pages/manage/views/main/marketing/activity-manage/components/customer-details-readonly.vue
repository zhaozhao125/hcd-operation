  ...
  <div id="customer-details">
    <v-page :visible.sync="visible" :before-close="handleBeforeClose">
      ...
      <div class="detail-content" slot="content" v-if="detailData">
        <detail-basic :detailData="detailData" :detailSettings="rechargingDetailSettings">
        ...
        <el-card class="table-box">
          <div class="table-container">
            <el-table v-loading="loading" :data="tableData" style="width: 100%">
              <el-table-column prop="orderSn" show-overflow-tooltip label="流水号" min-width="120">
              </el-table-column>
              <el-table-column prop="invoiceMoney" label="充值金额（元）" show-overflow-tooltip min-width="100">
              </el-table-column>
              <el-table-column min-width="180" prop="payTime" label="支付时间">
...
import { rechargingDetailSettings } from './rechargingDetailSettings'
export default {
  name: 'v-details',
  components: {
    detailBasic,
  ...
  data() {
    return {
      detailData: null,
      detailSettings: rechargingDetailSettings,
