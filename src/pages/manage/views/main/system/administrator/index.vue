<template>
  <div class="administrator">
    ...
    <v-page :visible.sync="newAdminVisible">
      ...
      <v-form ref="addForm" slot="content" :formSettings="formSettings" @save="handleSaveAdmin"></v-form>
    </v-page>
    <el-dialog title="编辑" :visible.sync="editDialogVisible" width="550px">
      <v-form ref="editForm" :formData="currentData" :formSettings="editSettings" showButton :btnLoading="editLoading" @save="submitEdit" @cancel="cancelEdit"></v-form>
    </el-dialog>
  </div>
</template>
<script>
